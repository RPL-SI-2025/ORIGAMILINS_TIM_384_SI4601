        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('admin.pesananevent.update', $pesanan->id_pesanan_event) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2" for="nama_event">
                                Nama Event
                            </label>
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                   id="nama_event"
                                   type="text"
                                   value="{{ $pesanan->nama_event }}"
                                   disabled>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <a href="{{ route('admin.pesananevent.index') }}" 
